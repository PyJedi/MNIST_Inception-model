...
def read_data(gcs_path):
   ...
   data = pd.read_csv(StringIO(file_stream.read()), header=None)
   # print(data.head())
   return data

train_set = read_data('gs://cmb/mnist_train.csv')
test_set = read_data('gs://cmb/mnist_test.csv')
...
for s in range(num_steps):
    ...
    if s == (num_steps-1):
        ...
        save_path = saver.save(sess,'gs://cmb/mnist/mnist.ckpt')
        print("Model saved.")
